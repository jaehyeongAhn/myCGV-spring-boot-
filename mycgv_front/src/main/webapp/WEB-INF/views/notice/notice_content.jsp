...
<body>
	...
	<div class="content">
		...
		<table class="boardContent">	
			...
			<tr>
				<td colspan="4">					
					<a href="http://localhost:9000/notice_list"><button type="button" class="btn_style">리스트</button></a>
					<a href="http://localhost:9000/index"><button type="button" class="btn_style">홈으로</button></a>
				</td>
			</tr>			
		</table>	
	</div>
